...
<div
    class="container w-2/3 h-full p-8 mx-auto my-5 rounded-lg shadow-lg bg-accent-50 dark:bg-gray-700"
>
    <form
            ...
            update_user_info()
                .then((data) => {
                    ...
                    localStorage.setItem(
                        "user",
                        JSON.stringify($user_info_store),
                    );
                })
                .catch((error) => {
                    console.error(error);
        ...
        <div class="flex flex-col space-y-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex">
                    <button
                        type="button"
                        class="px-4 py-2 font-bold text-white transition duration-150 ease-in-out bg-blue-500 rounded hover:bg-blue-700"
                        on:click={() =>
        ...
        <div class="grid gap-6 pt-5 mb-6 md:grid-cols-2">
            <div>
                ...
                <Input
                    type="text"
                    id="first_name"
                    bind:value={user_info.first_name}
                />
            </div>
            <div>
            ...
            <div>
                ...
                <Input
                    type="text"
                    id="last_name"
                    bind:value={user_info.last_name}
                />
            </div>
            <div>
