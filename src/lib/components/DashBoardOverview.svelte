<div
    class="grid grid-cols-1 gap-4 p-4 mb-4 rounded-lg overview-section md:grid-cols-4"
>
    <!-- Task Completion Rate Card -->
    <div class="p-4 rounded-lg shadow card">
    ...
    <!-- Active Tasks Card -->
    <div class="p-4 bg-blue-100 rounded-lg shadow card">
    ...
    <div class="p-4 bg-green-100 rounded-lg shadow card">
    ...
    <!-- Personal Goal Card -->
    <div class="p-4 bg-yellow-100 rounded-lg shadow card">
