<script lang="ts">
  ...
  let title_class: string = "text-sm text-gray-600 text-center";
  let value_class: string = "text-2xl font-bold text-center";
  let wrapper_class: string =
    "p-4 rounded shadow-xl border border-accent-200 dark:border-accent-700";
</script>

<div class="p-4 bg-accent-100 dark:bg-accent-700 rounded shadow-xl">
  <div class="mb-16 text-2xl font-bold text-black text-center">{title}</div>
