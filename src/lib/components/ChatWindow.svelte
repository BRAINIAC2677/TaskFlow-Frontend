<script lang="ts">
    ...
    async function fetch_messages(_task_id: number) {
        ...
        try {
            ...
            console.error(
                "An error occurred while retrieving the messages:",
                error,
            );
        }
    }
...
<div class="flex-1 p-4 overflow-auto bg-accent-100 dark:bg-accent-900">
    ...
    {#if fetchingMessages}
        <div class="flex flex-col items-center justify-center space-y-4">
            ...
            <div>
                <span
                    class="text-lg font-bold text-black md:text-xl dark:text-white"
    ...
    <div class="pt-4 text-center">
        ...
        ></textarea>
        <button
            class="flex items-center justify-center w-20 h-10 px-4 py-2 mx-auto mt-2 font-bold transition-all border-2 rounded text-accent-900 max-w-3px border-accent-50 hover:bg-accent-50"
