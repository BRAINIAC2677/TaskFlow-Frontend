...
<div class="flex-1 p-4 bg-accent-50 dark:bg-accent-700">
    ...
    <div class="pt-4 text-center">
        ...
        ></textarea>
        <button
            class="flex items-center justify-center w-20 h-10 px-4 py-2 mx-auto mt-2 font-bold text-black rounded max-w-3px bg-accent-500 hover:bg-accent-700"
